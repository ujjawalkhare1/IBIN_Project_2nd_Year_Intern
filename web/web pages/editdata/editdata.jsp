...
<table>
 ...
 <script>
    ...
    function flag(){
        ...
        %>
        document.location.href="../home/data.jsp";
    ...
    while(r.next())
     ...
     <tr>
         ...
         <td> <a target='_blank' href="javascript:show('<%= r.getString("id") %>' );" style='text-decoration: none'> <button>Edit</button></a></td>     
     ...
     <td> <a target='_blank' > <%=(r.getString("id")==null)?"-":r.getString("id") %></a></td> </tr>
