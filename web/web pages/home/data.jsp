  ...
  <tr>
     ...
     <% 
      ...
      sql1=sql;
        ...
        else
        {
            ...
            String sql2 = "select * from test where scientificname ilike "+search1+" or author ilike "+search1+" or institute ilike "+search1+" or state ilike "+search1 +" or year ilike "+search1+                                                                                                        
      ...
      if(var!=null)
        {
            ...
            String update="insert into test(scientificname, author, institute, state, year, kingdom, phyllum, class, subclass, order_, genus, family_, species, submissiondate,picname,habit, latitude, longitude, datasetkey, id) select scientificname, author, institute, state, year, kingdom, phyllum, class, subclass, order_, genus, family_, species, submissiondate,picname, habit, latitude, longitude, datasetkey, id  from "+temp+";";
   ...
   int flag=0;
    while(r.next())
     ...
     <td> <a target='_blank' > <%=(r.getString("id")==null)?"-":r.getString("id") %>  </a>  </td>
     ...
     <script type="text/javascript">
            function show(b) 
            {  alert(b);
         document.location.href="../googlemap/googlemap.jsp?id="+b; //"&;
