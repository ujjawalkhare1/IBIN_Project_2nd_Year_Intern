...
<html>
    ...
    <body>
        ...
        <%
String[] Order= new String[18];
String[] std1 = new String[]{"scientificname", "author", "institute","state","year", "kingdom", "phyllum", "class", "subclass", "order_", "genus", "family_", "species", "submissiondate", "picname", "habit", "latitude", "longitude"};
String st=null;
