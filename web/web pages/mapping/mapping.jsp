...
<body>
 ...
 <form method="post" action="mapping1.jsp">
     ...
     <%
         ...
         String[] std = new String[]{"scientificname", "author", "institute","state","year", "kingdom", "phyllum", "class", "subclass", "order_", "genus", "family_", "species", "submissiondate", "picname", "habit", "latitude", "longitude"};
