...
<html>
    ...
    <body>
        ...
        <%!
            String guidGen() {
        String SALTCHARS = "1234567890ABCDEF";
        StringBuilder salt = new StringBuilder();
        Random rnd = new Random();
   ...
   String temp = random_();
            ...
            String create="CREATE TABLE "+temp+" (scientificname text, author text, institute text, state text, year text, kingdom text, phyllum text, class text, subclass text, order_ text, genus text, family_ text, species text, submissiondate text, picname text,  habit text, latitude text, longitude text, datasetkey text, id text);";                                                                  
            ...
            int count1=0;
            int i=0;
            String datasetkey= (String)session.getAttribute("timestamp");
            String id= null;
